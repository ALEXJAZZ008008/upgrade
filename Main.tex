...
\newacronym{XCAT}{XCAT}{\gls{4D} Extended Cardiac Torso}
...
\newacronym{kVp}{kVp}{Kilo Voltage}
...
\newacronym{SGD}{GD}{Stochastic Gradient Descent}
...
\newacronym{3DPC}{3DPC}{\gls{3D} Point Cloud}
