        ...
        \subsection{Data acquisition} \label{sec:data_acquisition}
            ...
            \subsubsection{2D and 3D Acquisition} \label{sec:2d_and_3d_acquisition}
                \begin{figure}
                    ...
                    \captionsetup{singlelinecheck=false, justification=raggedright}
                    \caption{} \label{fig:2d_and_3d_acquisition_septa}
                \end{figure}
            ...
            \subsubsection{Photon Detection} \label{sec:photon_detection}
                \begin{figure}
                    ...
                    \captionsetup{singlelinecheck=false, justification=raggedright}
                    \caption{} \label{fig:photon_detection_detector}
                \end{figure}
                ...
                \begin{figure}
                    ...
                    \captionsetup{singlelinecheck=false, justification=raggedright}
                    \caption{} \label{fig:photon_detection_photomultiplier}
                \end{figure}
            ...
            \subsubsection{Coincidence Processing} \label{sec:coincidence_processing}
                ...
                \begin{figure}
                    ...
                    \captionsetup{singlelinecheck=false, justification=raggedright}
                    \caption{} \label{fig:coincidence_processing_coincidence_processing}
                \end{figure}
            ...
            \subsubsection{Time of Flight PET} \label{sec:time_of_flight_pet}
                \begin{figure}
                    ...
                    \captionsetup{singlelinecheck=false, justification=raggedright}
                    \caption{} \label{fig:time_of_flight_pet_tof}
                \end{figure}
