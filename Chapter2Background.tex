...
%                \end{itemize}
    ...
    \longsection{Inverse Problems and Optimisation}{sec:inverse_problems_and_optimisation}
        ...
        \subsection{Inverse Problem Concepts} \label{sec:inverse_problem_concepts}
            ...
            second, ideally, a model of the noise present in the system~\boxcite{Brusaferri2020ImprovingInformation, Emond2020ImprovingEffectiveness}. %KT what ``at least''. I'd say ``ideally'' %ACW done
