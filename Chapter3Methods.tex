\chapter{Results} \label{sec:results}
    ...
    \longsection{Impact of TOF on Respiratory Motion Modelling using NAC PET}{sec:impact_of_tof_on_respiratory_motion_modelling_using_nac_pet}
        ...
        \subsection{Results} \label{sec:impact_of_tof_on_respiratory_motion_modelling_using_nac_pet_results}
            ...
            \end{figure}
             ...
             \gls{COM} results can be seen in~\Fref{fig:impact_of_tof_on_respiratory_motion_modelling_using_nac_pet_results_com_graph}. The path of the \gls{NAC} \gls{TOF} data follows the ground truth path much closer than the \gls{NAC} \gls{NTOF} data, and is quite close to the gold standard \gls{XCAT}-derived motion.
    ...
    \longsection{Impact of TOF on Respiratory Motion Modelling using NAC PET: an Extension to Inter and Intra Respiratory Cycle Variation}{sec:impact_of_tof_on_respiratory_motion_modelling_using_nac_pet_an_extension_to_inter_and_intra_respiratory_cycle_variation}
